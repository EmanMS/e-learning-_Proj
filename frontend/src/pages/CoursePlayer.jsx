...
const CoursePlayer = () => {
    ...
    const fetchCourse = async () => {
        try {
            ...
            if (response.data.modules && response.data.modules.length > 0) {
                ...
                if (response.data.modules[0].contents && response.data.modules[0].contents.length > 0) {
    ...
    const fetchProgress = async () => {
        try {
            ...
            const completed = new Set(response.data.map(p => p.content));
    ...
    if (!course.is_enrolled) {
        return (
            <div className="max-w-4xl mx-auto p-4 sm:p-6 bg-white rounded shadow-md mt-10 text-center">
                ...
                {course.price > 0 ? (
                    <button
                        ...
                        className="w-full sm:w-auto bg-green-600 text-white px-8 py-3 rounded-lg text-xl hover:bg-green-700"
                    >
                    ...
                    <button
                        ...
                        className="w-full sm:w-auto bg-blue-600 text-white px-8 py-3 rounded-lg text-xl hover:bg-blue-700"
                    >
                        Enroll for Free
                    </button>
                )}
    ...
    return (
        <div className="flex flex-col lg:flex-row h-screen bg-gray-100">
            {/* Sidebar */}
            <div className="w-full lg:w-80 bg-white shadow-md overflow-y-auto flex flex-col">
